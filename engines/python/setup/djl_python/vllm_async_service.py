...
def convert_lmi_schema_to_completion_request(
    ...
    completion_dict = {
        ...
        "max_tokens": parameters.get("max_new_tokens"),
        "best_of": parameters.get("best_of"),
        "echo": parameters.get("return_full_text"),
        "seed": parameters.get("seed"),
        "stop": parameters.get("stop"),
        "truncate_prompt_tokens": parameters.get("truncate"),
        "top_p": parameters.get("top_p"),
        "top_k": parameters.get("top_k"),
        "temperature": parameters.get("temperature"),
        "repetition_penalty": parameters.get("repetition_penalty"),
        "n": parameters.get("top_n_tokens"),
